...
public class BoardImplTest {
    ...
    private BoardImpl initializeStandardBoard() {
        Map<String, Column> columns = initializeColumns();
        return new BoardImpl(columns, new KinbinImpl());
    }

    private BoardImpl initializeBoardWithReplenishmentColumn() {
    ...
    private BoardImpl initializeBoardWithWorkStageColumn() {
        Column column = new Column(COLUMN_TEST);
    ...
    private BoardImpl initializeBoardWithQueueColumn() {
        Column column = new Column(COLUMN_TEST);
        column.setAsQueue();
        Map<String, Column> columns = Maps.newHashMap(COLUMN_TEST, column);
        return new BoardImpl(columns, new KinbinImpl());
    ...
    private BoardImpl initializeBoardWithEndColumn() {
        Column column = new Column(COLUMN_TEST);
        column.setAsEnd();
        Map<String, Column> columns = Maps.newHashMap(COLUMN_TEST, column);
        return new BoardImpl(columns, new KinbinImpl());
